...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function addChart(cellId) {
      ...
      console.log(row, column, 'row and col to ');
    ...
    value: function _swapChartId(newerChartId, olderChartId) {
      var charts = this.state.charts;
      var highestRowSpan = null;
      var highestColSpan = null;
      // charts[olderChartId]['id'] = newerChartId;
      // charts[newerChartId]['id'] = olderChartId;

      // charts[olderChartId]['clonedFrom'] = olderChartId;
      var clonedChart = charts[newerChartId];
      var originalChart = charts[olderChartId];

      var clonedChartColSpan = clonedChart.startingColumnSpan;
      var originalChartColSpan = clonedChart.startingColumnSpan;
      var clonedChartRowSpan = clonedChart.startingRowSpan;
      var originalChartRowSpan = clonedChart.startingRowSpan;

      highestColSpan = clonedChartColSpan >= originalChartColSpan ? //
      clonedChart.startingColumnSpan : //
      originalChart.startingColumnSpan;

      highestRowSpan = clonedChartRowSpan >= originalChartRowSpan ? //
      clonedChart.startingRowSpan : //
      originalChart.startingRowSpan;

      console.log(highestColSpan, 'highest col');
      console.log(clonedChart, originalChart, 'this is the chart before swap');
      var cloneToOriginal = Object.assign({}, charts[newerChartId], {
        'id': olderChartId,
        'cloneId': newerChartId
      }, {
        'startingColumnSpan': highestColSpan
      });
      var originalToClone = Object.assign({}, charts[olderChartId], {
        'id': newerChartId,
        'cloneId': olderChartId
      }, {
        'startingColumnSpan': highestColSpan
      });
      console.log(olderChartId, 'this is olderchart');
      console.log(cloneToOriginal, originalToClone, 'this is the chart after swap');

      delete charts[olderChartId];
      delete charts[newerChartId];

      charts[olderChartId] = cloneToOriginal;
      charts[newerChartId] = originalToClone;

      console.log(charts, 'charts from swap');

      this.setState({ charts: charts });
    }
  }, {
    key: '_resetCloneStatus',
    value: function _resetCloneStatus(chartId) {
      var charts = this.state.charts;

      delete charts[chartId]['cloneId'];
    ...
    value: function renderCharts() {
      ...
      return this.state.chartList.map(function (chartId, index) {
        ...
        if (chartInfo.cloneId) {
          id = chartInfo.cloneId;
        } else {
          id = chartInfo.id;
        }
...
var Chart = function (_Component) {
  ...
  _createClass(Chart, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      console.log(nextProps, this.id, 'this is props');
    ...
    value: function _copyChart(e) {
      ...
      // this.id = res;
      // const focusedNode = document.getElementsByName(res)[0];
      // return focusedNode;
      // })
      // .then(chart => {
    ...
    value: function render() {
      ...
      // onDragStart={(e, d) => {
      //       !e.shiftKey ? this._startDragEvent(e) : //
...
var Row = function Row(_ref) {
  var matrixCells = _ref.matrixCells,
      cellsInRow = _ref.cellsInRow,
      rowId = _ref.rowId,
      addChart = _ref.addChart,
      setStartingDOMLocation = _ref.setStartingDOMLocation,
      updateMatrixCell = _ref.updateMatrixCell;

  var renderCells = cellsInRow.map(function (cell, index) {
    var matrixCell = matrixCells[cell];
...
var Cell = function (_Component) {
  ...
  function Cell(props) {
    ...
    _this.cellId = _this.props.cellId;
  ...
  _createClass(Cell, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var cell = (0, _reactDom.findDOMNode)(this);
      var cellLocation = cell.getBoundingClientRect();
      var x = cellLocation.left;
      var y = cellLocation.top;
    ...
    value: function renderSelector() {
      return this.state.canAddChart && _react2.default.createElement(_selector2.default, {
...
var Selector = function Selector(_ref) {
  var setChartToCell = _ref.setChartToCell;
  return _react2.default.createElement(
    'button',
    {
      className: 'selector',
      onClick: function onClick(e) {
        e.preventDefault();setChartToCell();
      } },
    _react2.default.createElement(
      'span',
      null,
