          ...
          onDragStop: function onDragStop(e, d) {
            ...
            if (e['target']['className'] == "chart") {
              if (_this8.clonedObjectId && !_this8.errorOnClone) {
                console.log('trued refresh in clone', _this8.domainPrefix, _this8.clonedObjectId, _this8.clonedOriginCell, _this8.rowSpan);
              ...
              if (!_this8.errorOnClone) {
                console.log('trued refresh out of clone', _this8.domainPrefix, _this8.objectId, _this8.clonedOriginCell, _this8.originCell);
