...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function copyCell(cellsInRow, rowId, cellId) {
      ...
      var idValues = [];
      console.log(this.rows[rowId]['cellsInRow'], 'cells in row');
      ...
      if (!cellToBeCopied.id) {
        console.log('made it first if');
        console.log(highestIdValue);
        ...
        console.log(cells);
      } else if (this.rows[rowId].length < this.state.columnCount) {
