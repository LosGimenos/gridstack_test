...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function renderRowsOrColumns(rowOrColumn) {
      if (rowOrColumn == 'row') {
        return this.state.rowCount.map(function (row) {
          return _react2.default.createElement('div', { className: 'row' });
        });
      } else {
        return this.state.columnCount.map(function (column) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'matrix' },
          this.renderRowsOrColumns('rows'),
          this.renderRowsOrColumns('columns')
        )
      );
    }
  }]);
