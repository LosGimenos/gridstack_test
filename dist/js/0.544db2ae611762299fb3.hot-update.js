...
var Chart = function (_Component) {
  ...
  function Chart(props) {
    ...
    _this.clonedOriginCell = _this.props.clonedOriginCell;
  ...
  _createClass(Chart, [{
    ...
    value: function _checkCloneOverlap(e) {
      ...
      if (onOccupiedCell) {
        ...
        try {
          ...
          this.props.swapLocation(_x4, _y4, this.clonedChartId, anchorCell, overlappedCells, this.id);
    ...
    value: function _copyChart(e) {
      ...
      var _props$addChart = this.props.addChart(this.originCell, rows, columns, true, this.objectID, this.id),
        ...
        _reactRnd2.default,
        {
          ...
          onDragStart: function onDragStart(e, d) {
            if (_this8.errorOnClone) {
              console.log('error on clone', _this8.id, Date.now());
              return false;
            } else {
          ...
          onDragStop: function onDragStop(e, d) {
            ...
            if (e['target']['className'] == "chart") {
              if (_this8.clonedObjectId && !_this8.errorOnClone) {
                console.log('trued refresh in clone', _this8.domainPrefix, _this8.clonedObjectId, _this8.clonedOriginCell, _this8.rowSpan, 'this is the id', _this8.id);
              ...
              console.log('trued refresh out of clone', _this8.domainPrefix, _this8.objectID, _this8.originCell, 'this is the id', _this8.id);
