  ...
  _createClass(Matrix, [{
    ...
    value: function addRow() {
      ...
      while (workingRow['cellsInRow'].length < this.state.columnCount) {
        ...
        var _highestIdValue = Math.max.apply(null, idValues);
        var newCell = cells[_highestIdValue + 1] = {
          id: _highestIdValue + 1,
          chartType: '',
          formula: '',
          title: ''
        };
    ...
    value: function addChart(chartType) {
      ...
      if (chartKeys.length == 0) {
        ...
        var _highestIdValue2 = Math.max.apply(null, chartKeys);
        chartKeys[_highestIdValue2 + 1] = {
          id: _highestIdValue2 + 1,
          chartType: chartType
        };
      }
