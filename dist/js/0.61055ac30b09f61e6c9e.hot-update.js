          ...
          onDragStop: function onDragStop(e, d) {
            ...
            if (e['target']['className'] == "chart") {
              if (_this8.clonedObjectId && _this8.clonedOriginCell) {
                console.log(_this8.clonedObjectId, _this8.clonedOriginCell, 'clone stuff');
              ...
              if (!_this8.originCell) {
                console.log('tried to delete', _this8.id);
                _this8.props.removeChart(_this8.id);
              } else {
                console.log('refreshed', _this8.originCell, _this8.id, _this8.objectID);
