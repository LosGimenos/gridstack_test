...
var Matrix = function (_Component) {
  ...
  function Matrix() {
    ...
    _this._getStartingCellLocation = _this._getStartingCellLocation.bind(_this);
    return _this;
  }
  ...
  _createClass(Matrix, [{
    ...
    key: '_getStartingCellLocation',
    value: function _getStartingCellLocation(chartId) {
      var charts = this.state.charts;
    ...
    value: function renderCharts() {
      ...
      return this.state.chartList.map(function (chartId, index) {
        ...
        return _react2.default.createElement(_chart2.default, {
          ...
          getStartingCellLocation: _this4._getStartingCellLocation
        });
      });
    }
  }, {
