...
var Matrix = function (_Component) {
  ...
  function Matrix() {
    ...
    _this.state = {
      ...
      rows: {
        '0': {
          cellsInRow: [_this.state.cells['11']]
        }
      },
      row_array: [_this.state.rows['0']],
      matrix: [_this.state.rows['0']],
      columnCount: 1
    };
  ...
  _createClass(Matrix, [{
    ...
    //   const row_position = row['cells_in_row'].length - 1;
    //   const cell_id = row_id.toString() +row_position.toString();
    //   cells[cell_id] = {
