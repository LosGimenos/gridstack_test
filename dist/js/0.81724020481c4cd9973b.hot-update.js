...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function addChart(cellId) {
      ...
      var originalChartId = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
      ...
      if (clonedTo) {
        (0, _core_api.replicate_chart)(this.setChartObjectId, this.domainPrefix, this.slideID, cellId, originalObjectId, newChartId, this.userID, cells, charts, chartList, originalChartId);
      } else {
    ...
    value: function setChartObjectId(newChartId, objectId, chartName, cells, charts, chartList, isClone, originalChartId) {
    ...
    key: '_swapLocation',
    value: function _swapLocation(x, y, cloneId, originCell, originCells, originalId) {
      var charts = this.state.charts;
