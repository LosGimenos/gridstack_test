...
var Chart = function (_Component) {
  ...
  _createClass(Chart, [{
    ...
    key: '_staggerCloneChartDelete',
    value: function _staggerCloneChartDelete(clonedChartId) {
      var _this5 = this;
      ...
      if (renderedClonedChart) {
        ...
        console.log('had to set interval');
        this.props.setErrorOnClone(this.clonedChartId);
        var chartDeleteInterval = setInterval(function () {
          renderedClonedChart = document.getElementsByName(_this5.clonedChartId)[0];
          if (renderedClonedChart) {
            console.log(renderedClonedChart, 'this is renderedClonedChart');
    ...
    value: function _checkCloneOverlap(e) {
      ...
      if (chart.tagName == 'HTML' || chart.tagName == 'document' || chart.tagName == 'BUTTON') {
        ...
        if (renderedClonedChart) {
          ...
          this.props.setErrorOnClone(this.clonedChartId);
          var chartDeleteInterval = setInterval(function () {
            renderedClonedChart = document.getElementsByName(_this6.clonedChartId)[0];
            if (renderedClonedChart) {
              console.log(renderedClonedChart, 'this is renderedClonedChart');
              _this6._clearClonedChartOnError();
              clearInterval(chartDeleteInterval);
            }
          }, 1500);
        }
      ...
      if (onOccupiedCell) {
        var _renderedClonedChart = document.getElementsByName(this.clonedChartId)[0];

        if (_renderedClonedChart) {
          console.log('we cleared immeditately');
          this._clearClonedChartOnError();
        } else {
          console.log('had to set interval');
          this.props.setErrorOnClone(this.clonedChartId);
          var _chartDeleteInterval = setInterval(function () {
            _renderedClonedChart = document.getElementsByName(_this6.clonedChartId)[0];
            if (_renderedClonedChart) {
              _this6._clearClonedChartOnError();
              clearInterval(_chartDeleteInterval);
            }
          }, 1200);
        }
        ...
        try {
          ...
          this.props.swapLocation(_x4, _y4, this.clonedChartId, anchorCell, overlappedCells);
