...
var _reactRnd = __webpack_require__(189);

var _reactRnd2 = _interopRequireDefault(_reactRnd);

var _matrixSizeModifiers = __webpack_require__(192);
...
var Chart = function (_Component) {
  ...
  _createClass(Chart, [{
    ...
    value: function render() {
      ...
      var cell = document.getElementsByName(this.originCell);

      return _react2.default.createElement(
        _reactRnd2.default,
        {
          size: { width: this.state.w, height: this.state.h },
          position: { x: this.state.x - Math.floor(matrix.offsetLeft / this.state.columnCount), y: this.state.y - matrix.offsetTop },
