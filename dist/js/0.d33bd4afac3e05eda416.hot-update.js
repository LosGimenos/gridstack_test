...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function addRow() {
      ...
      this.rows[row_index + 1]['cellsInRow'].push(firstCell);

      while (this.rows[row_index + 1]['cellsInRow'].length < this.state.columnCount) {
        this.rows[row_index + 1]['cellsInRow'].push('');
      }
      var row = this.rows[row_index + 1];
      rowArray.push(row);
