    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactRnd2.default,
        {
          ...
          position: {
            x: this.state.x - this.baseHeight * _matrixSizeModifiers2.default['rows'][this.state.rowCount],
            // + (cell.offsetWidth / 16),
            y: this.state.y - this.baseWidth * _matrixSizeModifiers2.default['columns'][this.state.columnCount]
