    ...
    value: function _checkCloneOverlap(e) {
      ...
      if (onOccupiedCell) {
        ...
        try {
          ...
          var cloneLocationX = cloneStartingCell['x'];
          var cloneLocationY = cloneStartingCell['y'];
          this._resetPosition(cloneLocationX, cloneLocationY);
          console.log(cloneLocationX, cloneLocationY, 'clone locs');
          console.log(cloneStartingCell, cloneStartingCellLocation, 'clone stuff');
