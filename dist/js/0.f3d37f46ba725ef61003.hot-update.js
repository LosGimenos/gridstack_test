  ...
  _createClass(Chart, [{
    ...
    value: function _copyChart(e) {
      ...
      var chartPromise = new Promise(function (resolve, reject) {
        var _props$addChart = _this7.props.addChart(_this7.originCell, rows, columns, true),
            chartId = _props$addChart.chartId;

        resolve(chartId);
      });

      chartPromise.then(function (res) {
        var focusedNode = document.getElementsByName(res)[0];
        return focusedNode;
      }).then(function (chart) {
        // res.focus();
        console.log(chart);
        ...
        _this7.originCells = overlappedCells;
      });
    ...
    value: function _clearChart(e) {
      ...
      this.originCells.forEach(function (cell) {
        _this8.props.unoccupyCell(cell);
      });
    }
  }, {
    key: '_callToDb',
      ...
      return _react2.default.createElement(
        _reactRnd2.default,
        {
          ...
          onDragStart: function onDragStart(e, d) {
            !e.shiftKey ? _this9._startDragEvent(e) : _this9._copyChart(e);
          },
          onDragStop: function onDragStop(e, d) {
            _this9.state.onCloneDrag ? _this9._checkCloneOverlap(e) : _this9._checkForOverlap(e);
            _this9.setState({ onCloneDrag: false });
          },
          onResizeStart: function onResizeStart(e, direction, ref, delta, position) {
            _this9._startResizeEvent(ref);
          },
          onResizeStop: function onResizeStop(e, direction, ref, delta, position) {
            _this9._checkResizeOverlap(e, delta);
          },
          enableResizing: {
            bottom: true,
            bottomLeft: false,
