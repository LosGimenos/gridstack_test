...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function _getStartingCell(chartId) {
      var charts = this.state.charts;
      var startingCellToSwap = charts[cloneId]['startingCell'];

      return startingCellToSwap;
    }
  }, {
    key: '_swapLocation',
    value: function _swapLocation(x, y, cloneId, originCell) {
      var charts = this.state.charts;
    ...
    value: function renderCharts() {
      ...
      return this.state.chartList.map(function (chartId, index) {
        ...
        return _react2.default.createElement(_chart2.default, {
          ...
          getStartingCell: _this4._getStartingCellLocation
        });
      });
    }
  }, {
    ...
    value: function _checkCloneOverlap(e) {
      ...
      if (onOccupiedCell) {
        ...
        try {
          ...
          // const { x, y } = this.props.getDOMLocationOfCell(this.clonedChartId);


          var cloneStartingCell = this.props.getStartingCell(this.clonedChartId);
          this.props.swapLocation(_x4, _y4, this.clonedChartId, anchorCell);
          _x4, _y4 = this.props.getDOMLocationOfCell(this.originCell);
