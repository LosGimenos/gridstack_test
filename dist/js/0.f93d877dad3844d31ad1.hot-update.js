...
var Matrix = function (_Component) {
  ...
  _createClass(Matrix, [{
    ...
    value: function copyFromHover(masterCell) {
      console.log('copy from hover run');
      var cells = this.cells;
      var cellsToCopy = this.hoveredCells;
      cellsToCopy.forEach(function (cell) {
        console.log(cells[cell.toString()]['chartType']);
        cells[cell.toString()]['chartType'] = cells[masterCell.toString()]['chartType'];
    ...
    value: function collectHoveredCells(cellId) {
      console.log('hovered cell collected');
