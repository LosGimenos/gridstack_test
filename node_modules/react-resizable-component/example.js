...
var BunchOfBoxes = React.createClass({
	render: function() {
	var parentStyle = {
		width: '100%',
		height: '100%'
	...
	var optionsWithGhostResize = {
		allowGhostResize: true
	};
	...
	return (
		...
		<h1>react-resizable-component</h1>
		<h2>Github: <a href="https://github.com/wongherlung/react-resizable-component">https://github.com/wongherlung/react-resizable-component</a></h2>
		<ResizableComponent className="test" style={normalBoxStyle} width={200} height={200}>
			<div style={innerDivStyle}>Drag downwards</div>
		</ResizableComponent>
		<ResizableComponent style={normalBoxStyle} width={200} height={200} direction="e">
			<div style={innerDivStyle}>Drag rightwards</div>
		</ResizableComponent>
		<ResizableComponent style={normalBoxStyle} width={200} height={200} direction="se">
			<div style={innerDivStyle}>Drag in the southeast direction</div>
		</ResizableComponent>
		<ResizableComponent style={normalBoxStyle} width={200} height={200} options={options}>
			<div style={innerDivStyle}>Drag downwards with 50px interval</div>
		</ResizableComponent>
		<ResizableComponent style={normalBoxStyle} width={200} height={200} direction="e" options={options}>
			<div style={innerDivStyle}>Drag rightwards with 50px interval</div>
		</ResizableComponent>
		<ResizableComponent style={normalBoxStyle} width={200} height={200} direction="se" options={options}>
			<div style={innerDivStyle}>Drag in the southeast direction with 50px interval</div>
		</ResizableComponent>
		<ResizableComponent style={normalBoxStyle} width={200} height={200} direction="se" 
			options={optionsWithGhostResize} onStopResize={sayHello}>
			<div style={innerDivStyle}>Drag in the southeast direction with ghost resizing</div>
		</ResizableComponent>
		</div>
	);
	}
